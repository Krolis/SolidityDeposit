...
export function assertNumberEqual(actual: Web3.AnyNumber,
...
export function assertEtherEqual(actual: Web3.AnyNumber,
                                 expect: Web3.AnyNumber) {
    return assertNumberEqual(actual, expect, ETH_DECIMALS);
}

export function assertTokenEqual(actual: Web3.AnyNumber,
                                 expect: Web3.AnyNumber) {
    return assertNumberEqual(actual, expect, ONL_DECIMALS);
}

export function assertTokenAlmostEqual(actual: Web3.AnyNumber,
                                       expect: Web3.AnyNumber,
                                       epsilon: Web3.AnyNumber) {
    return assertNumberAlmostEqual(actual, expect, epsilon, ONL_DECIMALS);
}

export function findLastLog(trans: TransactionResult,
